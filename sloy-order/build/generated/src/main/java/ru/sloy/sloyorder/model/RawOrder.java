...
/**
 * Заказ без лишних полей для создания заказа и массивом пар &lt;itemId, itemNumber&gt;
 */

@Schema(name = "RawOrder", description = "Заказ без лишних полей для создания заказа и массивом пар <itemId, itemNumber>")
